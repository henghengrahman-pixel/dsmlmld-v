...
function humanActionButtons(x){
  ...
  if(intent==='FORGOT_PASSWORD') return `<button class="quickaction" data-hact="RESET_DEPOSIT_FIRST" data-hid="${x.id}">Suruh Deposit Dahulu</button>`;
