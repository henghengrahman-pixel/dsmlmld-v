...
test('telegram group hanya reset password WD dan bonus',()=>{
  ...
  assert.doesNotMatch(html,/Deposit Problem/);
  assert.doesNotMatch(html,/Custom Human Request/);
});
...
test('AI prompt melarang janji kemenangan dan tebakan',()=>{
  ...
  assert.match(s,/ASK_HUMAN dengan reply kosong/);
});
