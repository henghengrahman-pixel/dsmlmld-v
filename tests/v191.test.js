...
test('long chats use cached digest and recent context',()=>{ assert.match(engine,/recentLimit=60/); assert.match(engine,/staleBy>=8/); assert.match(engine,/digestConversation/); });
...
test('unclear cases route silently to staff',()=>{ assert.match(ai,/gunakan ASK_HUMAN dan reply kosong/); assert.match(engine,/silent_wait_staff/); });
