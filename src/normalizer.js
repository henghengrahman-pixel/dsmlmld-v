const typoMap = new Map(Object.entries({
  ...
  'psw':'password','pw':'password','pass':'password','paswod':'password','pasword':'password',
  ...
  'akun':'akun','user':'username','usr':'username'
}));
...
export function detectIntent(text='') {
  ...
  if (has('password','lupa') || has('lupa','password') || (t.includes('reset') && t.includes('password')) || (t.includes('ganti') && t.includes('password'))) return 'FORGOT_PASSWORD';
  ...
  if (t.includes('kalah') || t.includes('kecewa') || t.includes('rugi') || t.includes('parah') || t.includes('rusak') || t.includes('marah')) return 'COMPLAINT';
