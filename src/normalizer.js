const typoMap = new Map(Object.entries({
  ...
  'knp':'kenapa','kpn':'kapan','skrg':'sekarang','tdk':'tidak','slmt':'selamat','smt':'selamat','mlm':'malam','malem':'malam','pgi':'pagi','pg':'pagi','sre':'sore','sor':'sore','sng':'siang','gngguan':'gangguan','gangguanx':'gangguan','limid':'limit','limitt':'limit','eror':'error','errorr':'error','rolingan':'rollingan','rolllingan':'rollingan','rolinggan':'rollingan','rolling':'rollingan','loginn':'login','ligin':'login','lgin':'login','lupa':'lupa','lpa':'lupa','lp':'lupa','lup':'lupa','alihin':'alihkan','alihkn':'alihkan','rek':'rekening',
...
export function detectIntent(text='') {
  ...
  // Deposit cancellation/reject is a distinct operational flow.
  if (
    t.includes('deposit') &&
    any('batal','batalkan','cancel','cancelkan','reject','tolak','hapus fom','hapus form','batalkan fom','batalkan form')
