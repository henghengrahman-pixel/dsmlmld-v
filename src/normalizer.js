...
export function detectIntent(text='') {
  ...
  if ((any('kemenangan','menang','payout','jackpot','jp','hasil menang') && any('belum dibayar','belum masuk','tidak dibayar','tidak masuk','pending','belum cair','gagal dibayar')) ||
      (any('saldo kemenangan','hasil kemenangan') && any('belum','tidak masuk','pending'))) return 'PAYOUT_NOT_RECEIVED';

  if (any('rekening','bank','dana','e wallet','ewallet') && any('limit','limited','limid','kena limit','batas')) return 'BANK_ACCOUNT_LIMIT';
  ...
  if (any('akses') && any('tidak bisa','gagal','error','blank','down','mati')) return 'LINK_PROBLEM';
