...
import { migrate, healthDb, pool, getSetting, setSetting, getContext, setHumanTakeover, clearHumanTakeover, withChatLock, isHumanTakeover, logError, insertMessage } from './db.js';
...
async function boot(){
  try{
    ...
    startPoller(lc);
    startCannedSync();
    startHumanBridge({livechat:lc,onAnswer:answerHumanRequest});
