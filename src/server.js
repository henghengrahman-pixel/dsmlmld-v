...
async function boot(){
  try{
    ...
    backfillHumanLearningAll({batchSize:2000,maxRows:100000}).then(r=>console.log('CS learning full backfill',r)).catch(e=>console.warn('CS learning backfill failed',e.message));
