...
export const config = {
  ...
  lcSitesJson: process.env.LIVECHAT_SITES_JSON || '',
...
export function validateConfig() {
  ...
  if ((!config.lcAccountId || !config.lcPat) && !config.lcSitesJson) warnings.push('LiveChat belum dikonfigurasi: isi LIVECHAT_ACCOUNT_ID/PAT atau LIVECHAT_SITES_JSON');
