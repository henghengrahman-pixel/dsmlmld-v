...
export function buildStyleInstruction(style={}) {
  ...
  if(replyStyle==='NATURAL_CS') lines.push('- Tulis seperti staf LiveChat manusia Indonesia, bukan seperti asisten AI. Natural, cepat, hangat, dan langsung ke inti.');
  ...
  lines.push('- Jangan pernah menyebut diri sebagai AI, model, bot, sistem, atau asisten kecuali memang diminta oleh aturan bisnis.');
