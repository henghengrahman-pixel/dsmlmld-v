...
${history}`;
  ...
  async classifyAndReply({normalized, intent, context, rules, knowledge, attachments=[], style={}, conversationDigest="", csStyleExamples=""}) {
