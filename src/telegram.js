export class TelegramClient {
  ...
  async sendMessage(chatId,text,{topicId=null,replyTo=null,parseMode=null}={}){
  ...
  async getUpdates({offset=0,timeout=20}={}){
    return this.call('getUpdates',{offset:Number(offset)||0,timeout,allowed_updates:['message']},(timeout+8)*1000);
  }
}
