...
export async function getConversationState(chatId){ const r=await pool.query(`SELECT chat_id,bootstrapped_at,human_takeover_until,last_event_at FROM conversations WHERE chat_id=$1`,[chatId]); return r.rows[0]||null; }
